...
if [[ "$1" == "ubuntu" ]]; then
    ...
    mv artifact-upload/lib/ruby/ruby_discord_game_sdk/ruby_discord_game_sdk.so artifact-upload/lib/ruby/x86_64-linux/
    ...
    mkdir -p artifact-upload/lib/ruby/x64-mswin64_140
    cp -r lib/ruby_discord_game_sdk/ruby_discord_game_sdk.so artifact-upload/lib/ruby/x64-mswin64_140 # the .so itself
